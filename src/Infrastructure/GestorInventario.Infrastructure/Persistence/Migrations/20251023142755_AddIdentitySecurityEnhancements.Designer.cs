...
namespace GestorInventario.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251023142755_AddIdentitySecurityEnhancements")]
    partial class AddIdentitySecurityEnhancements
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GestorInventario.Domain.Entities.DemandAggregate", b =>
                {
                    ...
                    b.HasIndex("VariantId", "PeriodStart", "Interval")
                        .IsUnique();
            ...
            modelBuilder.Entity("GestorInventario.Domain.Entities.SeasonalFactor", b =>
                {
                    ...
                    b.HasIndex("VariantId", "Interval", "Sequence", "EffectiveFrom");
